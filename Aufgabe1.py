...
with open('File_B_In2019_L.csv', encoding='mac_roman') as csvdatei, open('File_A_Inf2019_L.csv', encoding='mac_roman') as csvdatei1:           # öffnet csv file
    ...
    csvfile = open('1.csv', 'w', encoding='mac_roman',  newline='')                                                          # erstellt neue CSV File                
...
with open('1.csv', encoding='mac_roman') as in_file, open('2.csv','w') as out_file:
...
import csv
from os import write
with open('2.csv', encoding='mac_roman') as test:
    csvreader = csv.DictReader(test, delimiter=';')
    csvfile = open('File_C_Inf2019l_Baba.csv', 'w', encoding='mac_roman',  newline='') 
